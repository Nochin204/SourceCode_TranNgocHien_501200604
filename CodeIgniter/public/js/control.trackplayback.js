    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            const o = a.a.Control.extend({
                ...
                _initContainer: function () {
                    return (
                        ...
                        (this._infoSpeedRatio = this._createInfo(
                            ...
                            'info-speed-ratio',
                            this._infoContainer,
                            // console.log(this.trackPlayBack.getSpeed()),
                        )),
                        ...
                        // (this._infoSpeedBoot = this._createBoot(this._infoSpeedRatio)),
                ...
                // _createBootX: function (t, e, i, n) {
                //     let o = a.a.DomUtil.create('div', 'bootspeed', n);
                //     a.a.DomUtil.create('span', 'info-title', o).innerHTML = t;
                //     let r = a.a.DomUtil.create('span', i, o);
                //     return (r.innerHTML = e), r;
                // },
                _createSlider: function (t, e, i) {
                    ...
                    return (
                        ...
                        a.a.DomEvent.on(n, 'click mousedown dbclick', a.a.DomEvent.stopPropagation)

        ...
        function (t, i, e) {
            ...
            const a = n.a.Class.extend({
                    ...
                    _getCalculateTrackPointByTime: function (t) {
                        ...
                        // nơi xử lí thời gian_____________________________________#
                        const w = {
                            cw: function (index) {
                                const tableElement = document.querySelector('.bakugan');
                                const tabLength = tableElement.childElementCount;
                                for (let i = 0; i < tabLength; i++) {
                                    tableElement.children[i].style.display = 'none';
                                }
                                tableElement.children[index].style.display = 'block';
                                tabTable.children[1].innerHTML = curTab + 1;
                            },
                        }
                        if (_time_ !== u.time) {
                            _time_ = u.time;
                            ...
                            if (curLine) {
                                curLine.classList.remove('active');
                            }
                            // console.log(_time_);
                            curLine = document.getElementById(`${_time_}`);
                ...
                h = n.a.Class.extend({
                    ...
                    _caculatefpsTime: function (t) {
                        let i;
                        return (
                            (i = 0 === this._lastFpsUpdateTime ? 0 : t - this._lastFpsUpdateTime),
